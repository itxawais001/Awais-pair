        ...
        sock.ev.on("connection.update", async (update) => {
            ...
            if (connection === "open") {
                ...
                try {
                    ...
                    const sessionId = "AWAIS-MD~" + base64;
                    ...
                    const successMsg = {
                        text:
                           `🚀 *AWAIS-MD- Session Created!*\n\n` +
                            ...
                            `▸ https://whatsapp.com/channel/0029Vb6ZweSKbYMUlxs2MM2N/1316`,
                        contextInfo: {
                            mentionedJid: [sock.user.id],
                            forwardingScore: 1000,
                            isForwarded: false,
                            forwardedNewsletterMessageInfo: {
                                newsletterJid: "https://whatsapp.com/channel/0029Vb6ZweSKbYMUlxs2MM2N/1316",
